...
#Setting up Germany Data-------------------------------------------------------------------
Germany_ts <- matrix(data = NA, nrow = l)
Germany_ts$Date <- dates
Germany_ts$Data <- xts(WW_Data$Germany_Germany, order.by = dates)
Germany_ts$Index <- xts(c(1:l), order.by = dates)

Germany_ts$p1 <- xts(c(rep(0, 4), rep(1, 16), rep(0, 36)), order.by = dates)
...
#Old Import of Data-------------------------------------------------------------------
EU_Data <- read_excel("Data/Data.xlsx", sheet = "Tabelle2", 
...
WW_Data <- read_excel("Data/Data.xlsx", sheet = "Data", 
                      col_types = c("date", "numeric", "numeric", 
